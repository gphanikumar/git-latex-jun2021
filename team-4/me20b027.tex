...
\end{equation}
\begin{center}
Reversible work done ~\cite{fleming_2021}
\end{center}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[scale=0.5]{me20b027a.eps}
	\end{center}
	\caption{Reversible Isothermal Expansion~\cite{libretexts_2020}}
	\label{fig:revexp}
\end{figure}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[scale=0.7]{me20b027b.eps}
	\end{center}
	\caption{P-V diagram for isothermal expansion~\cite{askiitians}}
	\label{gr:istexp}
\end{figure}
